...
export const SearchSidebar = () => {
  ...
  const groupedByFileSearchResultForRender = useDeferredValue(groupedByFileSearchResult);

  return (
    <UseDarkContextProvider>
      <LoadingBar loading={searching} />
      <SearchWidgetContainer />
      <SearchProviderMessage query={queryInFlight} error={searchError} results={groupedByFileSearchResultForRender} />
